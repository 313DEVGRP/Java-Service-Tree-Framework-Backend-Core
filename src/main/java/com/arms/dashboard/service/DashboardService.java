...
public interface DashboardService {
    ...
    검색결과_목록_메인 제품서비스_일반_통계(Long pdServiceId, 지라이슈_일반_검색_요청 검색요청_데이터);

    Map<String, Object> 제품서비스_요구사항제외_일반_통계(Long pdServiceId, 지라이슈_일반_검색_요청 검색요청_데이터);

    List<Object> 제품서비스_요구사항제외_일반_통계_TOP_5(Long pdServiceId, 지라이슈_일반_검색_요청 검색요청_데이터);

    Map<String, Object> getIssueResponsibleStatusTop5(Long pdServiceId, 지라이슈_일반_검색_요청 검색요청_데이터);
}
