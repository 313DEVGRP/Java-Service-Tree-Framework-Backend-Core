...
@Setter
@NoArgsConstructor
public class 지라이슈_제품_및_제품버전_집계_요청 {
    ...
    @Builder
    private 지라이슈_제품_및_제품버전_집계_요청(Long pdServiceLink, List<Long> pdServiceVersionLinks, List<String> 하위그룹필드들, String 메인그룹필드, int 크기, int 하위크기, boolean 컨텐츠보기여부, IsReqType isReqType) {
