...
public interface 통계엔진통신기 {
    ...
    ResponseEntity<List<상품_서비스_버전>> 요구사항_별_상태_및_관여_작업자_수(@SpringQueryMap 지라이슈_제품_및_제품버전_병합_검색_요청 지라이슈_제품_및_제품버전_검색요청);

    @GetMapping("/engine/jira/dashboard/req-status-and-reqInvolved-unique-assignees3")
