                ...
                for (ReqStatusEntity 요구사항_이슈_엔티티 : 결과) {
                    ...
                    if (지라서버 == null) {
                        ...
                        if (요구사항_이슈_엔티티.getC_issue_key() == null) {
                            log.info("[스케쥴러_컨트롤러 :: 각_제품서비스_별_요구사항_Status_업데이트_From_ES] :: 해당 요구사항은 ALM 서버에 생성되지 않았습니다.확인이 필요합니다. C_ID = " + 요구사항_이슈_엔티티.getC_id());
                        }
                        else if (요구사항_이슈_엔티티.getC_issue_delete_date() != null) {
                            log.info("[스케쥴러_컨트롤러 :: 각_제품서비스_별_요구사항_Status_업데이트_From_ES] :: 해당 요구사항은 암스에서 삭제된 요구사항입니다. C_ID = " + 요구사항_이슈_엔티티.getC_id());
                        }
                        else {
